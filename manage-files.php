					...
					while ( $row = $sql->fetch() ) {
						...
						$image_icon = "";
                                                if ( in_array( $extension, $image_extensions ) ) {
                                                	$this_thumbnail_url = UPLOADED_FILES_URL.$row['url'];
                                                	if (THUMBS_USE_ABSOLUTE == '1') {
        	                                        	$this_thumbnail_url = BASE_URI.$this_thumbnail_url;
                                                	}
							$image_icon = '<img src="' . TIMTHUMB_URL . '?src=' . $this_thumbnail_url . '&amp;w=64&amp;h=64'  . '&amp;q=' . THUMBS_QUALITY . '">';
						}
						...
						$tbody_cells = array(
												...
												array(
													'content'		=> $image_icon.'</br>'.$formatted_size,
												),
												array(
