 ...
 *
 */
define('SYSTEM_URI','https://www.dajana.cn/');
define('SYSTEM_URI_LABEL','ProjectSend on github');
define('DONATIONS_URL','https://www.dajana.cn/donations/');
/** Previously cFTP */
define('SYSTEM_NAME','Youhong');
