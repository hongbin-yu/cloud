...
$validation_no_device			= __('Device ID was not completed','cftp_admin');
...
$validation_alpha_device		= __('Device ID must be alphanumeric and may contain dot (a-z,A-Z,0-9 and . allowed)','cftp_admin');
