...
<div class="col-xs-12">
	<div id="wrapper">
							...
							<form action="" name="files_filters" method="get" class="form-inline form_filters">
								...
								<div class="form-group group_float">
									<select name="category" id="category" class="txtfield form-control">
										<option value="0"><?php _e('Add all','cftp_admin'); ?><?php _e('Categories','cftp_admin'); ?></option>
										<?php
				...
				<?php
					...
					if ($count > 0) {
						...
						$table_attributes	= array(
													'id'		=> 'files_list',
													'class'		=> 'footable table mdb-lightbox',
												);
        ...
        $preview_icon = '<a data-toggle="lightbox" /*data-gallery="example-gallery"*/ href="../' . $this_thumbnail_url.'"><img src="';
	$preview_icon = $preview_icon. TIMTHUMB_URL . '?src=' . $this_thumbnail_url . '&amp;w=64&amp;h=64' . '&amp;q=' . THUMBS_QUALITY . '" class="thumbnail img-fluid" ></a>';								}
	...
	$preview_cell = '<a data-toggle="lightbox" data-gallery="example-gallery" href="../' . $this_thumbnail_url.'"><img src="'. TIMTHUMB_URL . '?src=' . $this_thumbnail_url . '&amp;w=' . THUMBS_MAX_WIDTH . '&amp;q=' . THUMBS_QUALITY . '" class="thumbnail img-fluid" alt="' . htmlentities($file['name']) .'" /></a>';
