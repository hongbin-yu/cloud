...
<head>
	...
	<?php meta_favicon(); ?>
        <link rel="stylesheet" media="all" type="text/css" href="/cloud/assets/bootstrap/css/bootstrap.min.css" />
        <link rel="stylesheet" media="all" type="text/css" href="<?php echo BASE_URI?>assets/bootstrap/css/ekko-lightbox.css" />
	...
	<div id="movable">
		...
		<div id="content">
			...
			?>
					<ul class="photo_list">
						...
						?>
								...
								<a href="<?php echo BASE_URI .'upload/files/'. $this_file['url'] ?>" data-toggle="lightbox" data-gallery="example-gallery">
												<?php
												...
												?>
												<img src="<?php echo TIMTHUMB_URL; ?>?src=<?php echo $this_thumbnail_url; ?>&amp;w=280&amp;h=215&amp;f=2&amp;q=<?php echo THUMBS_QUALITY; ?>" class="img-fluid img-responsive" alt="<?php echo htmlentities($this_file['name']); ?>" />
											</a>
										</div>
										<div class="img_data">
			...
			<?php default_footer_info(); ?>
              ...
              <script src="<?php echo BASE_URI?>assets/bootstrap/js/ekko-lightbox.min.js"></script>
<script>
