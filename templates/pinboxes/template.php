							...
							<div class="photo_int">
								...
								?>
										<div class="img_prev">
											...
											?>
                                                                                                        <a href="<?php echo BASE_URI .'upload/files/'. $file['url'] ?>" data-toggle="lightbox"  data-gallery="example-gallery">  
													<!--a href="<?php echo $download_link; ?>" target="_blank"-->
														...
														?>
														<img src="<?php echo TIMTHUMB_URL; ?>?src=<?php echo $this_thumbnail_url; ?>&amp;w=250&amp;q=<?php echo THUMBS_QUALITY; ?>" class="img-fluid" alt="<?php echo htmlentities($file['name']); ?>" />
													</a>
											<?php
												}
											?>
